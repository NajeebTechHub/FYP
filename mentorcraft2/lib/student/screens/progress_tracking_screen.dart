...
class ProgressTrackingScreen extends StatefulWidget {
  ...
  const ProgressTrackingScreen({Key? key, required this.progressSummary}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: TabBarView(
        controller: _tabController,
        children: [
          OverviewTab(progressSummary: widget.progressSummary, isTablet: isTablet),
          AnalyticsTab(isTablet: isTablet, courseProgress: [],),
          CertificatesTab(progressSummary: widget.progressSummary, isTablet: isTablet),
        ],
      ),
    );
  }
...
//         children: [
//           // Overview Tab
//           buildOverviewTab(context, isTablet),
//
//           // Analytics Tab
...
//   }
//
//   Widget buildOverviewTab(BuildContext context, bool isTablet) {
