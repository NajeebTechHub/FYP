...
import '../widgets/enrolled_courses.dart';
...
class _MyCoursesScreenState extends State<MyCoursesScreen> with SingleTickerProviderStateMixin {
  ...
  Future<void> _loadEnrolledCourses() async {
    ...
    _enrolledCourses = [
      EnrolledCourse(
        course: Course(
          id: '1',
          name: 'Flutter Mobile App Development Masterclass',
      ...
      EnrolledCourse(
        course: Course(
          id: '2',
          name: 'UI/UX Design Principles for Mobile Applications',
          description: 'Master the fundamentals of designing beautiful user interfaces',
          imageUrl: 'https://images.unsplash.com/photo-1545235617-9465d2a55698?q=80&w=2080',
          price: 59.99,
          duration: '18 hours',
          level: 'Beginner',
          rating: 4.8,
  ...
  void _continueLearning(EnrolledCourse course) {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Text('Continuing ${course.course.name}'),
