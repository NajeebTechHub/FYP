...
class _CreateQuizScreenState extends State<CreateQuizScreen> {
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      _numberField(
                          controller: _attemptsController, label: 'Attempts'),
                      const SizedBox(width: 8),
                      _numberField(
  ...
  Widget _numberField(
    ...
    return Expanded(
      child: TextFormField(
        ...
        validator: (value) =>
            value == null || int.tryParse(value) == null ? 'Invalid' : null,
      ),
    );
  }
  ...
  void _showQuestionDialog({QuizQuestion? question, int? index}) {
    ...
    final pointsController =
        TextEditingController(text: question?.points.toString() ?? '1');
  ...
  void _createQuizWithStatus(bool isActive) {
    ...
    final selectedCourse =
        teacherProvider.courses.firstWhere((c) => c.id == _selectedCourse);
    ...
    ScaffoldMessenger.of(context).showSnackBar(SnackBar(
      content:
          Text('Quiz ${isActive ? 'created' : 'saved as draft'} successfully'),
